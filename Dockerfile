...
# docker build -t reelix_manager .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name reelix_manager reelix_manager
...
# The entrypoint runs as root to fix volume permissions, then drops to this user via gosu.
