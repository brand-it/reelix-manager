...
Doorkeeper.configure do
  ...
  #
  # No default scopes — clients must explicitly request what they need.
  # all:    unrestricted access to every operation
  # search: TMDB search queries (searchMulti, node, nodes)
  # upload: file upload mutations (finalizeUpload)
  optional_scopes :all, :search, :upload
