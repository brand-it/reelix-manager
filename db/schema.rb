...
ActiveRecord::Schema[8.1].define(version: 2026_04_21_163117) do
  ...
  create_table "tus_upload_sessions", id: :string, force: :cascade do |t|
    ...
    t.index ["finalized"], name: "index_tus_upload_sessions_on_finalized"
    t.index ["fingerprint"], name: "index_tus_upload_sessions_on_fingerprint"
    t.index ["user_id"], name: "index_tus_upload_sessions_on_user_id"
    t.index ["video_blob_id"], name: "index_tus_upload_sessions_on_video_blob_id"
  end
  ...
  create_table "video_blobs", force: :cascade do |t|
    ...
    t.string "filename", null: false
    t.boolean "finalizing", default: false, null: false
    t.string "key", null: false
    ...
    t.datetime "updated_at", null: false
    t.integer "year"
    t.index ["finalizing"], name: "index_video_blobs_on_finalizing"
