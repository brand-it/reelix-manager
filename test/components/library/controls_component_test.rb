...
class Library::ControlsComponentTest < ViewComponent::TestCase
  test "renders turbo stream search form with active media filter" do
    ...
    assert_selector "input[type='radio'][name='media_type'][value='tv'][data-action='change->submit-on-keyup#submit']", visible: false
